...
//V2
    ...
    public Call<GermplasmListResponse> searchGermplasmResult(@Path(value="searchResultDbId") String searchResultDbId, @Query(value="pageSize") String var1, @Query(value="page") String var2);

//    //V2
//    @POST(value="search/samples")
//    public Call<BrapiListResource<Sample>> searchSamplesDirectResult(@Body Map<String, Object> body);
//    
//    @GET(value="search/samples/{searchResultDbId}")
//    public Call<BrapiListResource<Sample>> searchSamplesResult(@Path(value="searchResultDbId") String searchResultDbId, @Query(value="pageSize") String var1, @Query(value="page") String var2);
